...
A thanks to Masatoshi Nishimura to his blog post [The Best Document Similarity Algorithm: A Beginner’s Guide](https://towardsdatascience.com/the-best-document-similarity-algorithm-in-2020-a-beginners-guide-a01b9ef8cf05) which is very inspriring.
...
With the `type` parameter you can distinguish between different types of names and with `ignore.case`
...
is the row index, the scrond column the column index and the third column the the matrix entry.
